...
- Achieved reliable sentiment predictions suitable for real-world review analysis.
- Designed the project with modular code and reproducible environment setup.
